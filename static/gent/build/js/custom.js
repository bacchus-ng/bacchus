			...
			if ($('#echart_pie2').length ){ 
			  ...
			  echartPieCollapse.setOption({
				...
				legend: {
				  x: 'center',
				  y: 'bottom',
				  data: ['CentOS', 'Other', 'SuSe', 'rose4', 'Debian', 'RedHat']
				},
				toolbox: {
				  show: true,
				  feature: {
			...
			if ($('#echart_donut').length ){  
			  ...
			  echartDonut.setOption({
				...
				legend: {
				  x: 'center',
				  y: 'bottom',
				  data: ['Direct Access', 'Connection Error', 'Backup Failed', 'Unknown', 'Search Engine']
				},
				toolbox: {
				  show: true,
				  feature: {
			...
			if ($('#echart_pie').length ){  
			  ...
			  echartPie.setOption({
				...
				legend: {
				  x: 'center',
				  y: 'bottom',
				  data: ['VM Not Found', 'Connection Error', 'Backup Failed', 'Unknown', 'Successful']
				},
				toolbox: {
				  show: true,
				  feature: {
